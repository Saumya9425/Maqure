...
const { Verifyotp,newsignup, newbuyer, GetBuyers, GetSingleBuyer, LoginBuyer, LogoutBuyer, UpdateBuyer, DeleteBuyer, GetBuyerBids, AutoLogin } = require('./routes/BuyerRoutes');
const { CreateProduct, GetallProduct, GetSingleProduct, UpdateProduct, DeleteProduct, UpdateManyProduct, Get8Product,GetProductByCategory } = require('./routes/ProductRoutes');
const error = require('./middleware/error');
const cookieParser = require("cookie-parser");
const { CreateSeller, SignUpSeller, LoginSeller, DeleteSeller, AddProdRequest, Sellerquote, Getsingleseller, Getallsellerquote, GetAllseller, SendCreateReq, UpdateSeller,GetAllSellerBids } = require('./routes/sellerRoutes');
const { CreateAdmin, LoginAdmin, ApproveSeller, RejectSeller, AddProduct, GetAllSellerRequest, GetAllProdRequest, Rejectorder, Adminclickprocess, Sendrfqadmin, Adminupdateprice, RemoveProduct } = require('./routes/AdminRoutes');
...
const {CreateProductCategory, GetAllCategory} = require('./routes/ProductCategoryRoutes')
