...
const { removeprod, createadmin, loginadmin, aproveseller, rejectseller, addproduct, getallsellerrequest, getalladdprodrequest, adminrejectorder,adminclickprocess, sendrfqadmin, adminupdateprice  } = require('../controller/AdminController');
...
const RemoveProduct = app.post('/request/removeprodreq',isAutharization , autherizesrole('admin') ,removeprod )
...
module.exports = { CreateAdmin , LoginAdmin , ApproveSeller , RejectSeller , AddProduct , GetAllSellerRequest , GetAllProdRequest ,Rejectorder , Adminclickprocess ,Sendrfqadmin ,Adminupdateprice , RemoveProduct}
