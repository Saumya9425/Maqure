...
const { createproduct, getallproduct, getsingleproduct, updateProduct, deleteProduct, updatemanyproduct, get8product ,getproductbycategory } = require('../controller/ProductController');
...
const GetProductByCategory = app.post('/category/product',getproductbycategory)




// exports
module.exports = { CreateProduct , GetallProduct , GetSingleProduct , UpdateProduct ,Get8Product, DeleteProduct , UpdateManyProduct,GetProductByCategory}